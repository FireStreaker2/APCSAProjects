...
public class BigFraction {
	...
	public BigFraction add(BigFraction fraction) {
		return new BigFraction(
				this.numerator.multiply(fraction.getDenominator())
						.add(fraction.getNumerator().multiply(this.denominator)),
	...
	public BigFraction subtract(BigFraction fraction) {
		return new BigFraction(
				this.numerator.multiply(fraction.getDenominator())
						.subtract(fraction.getNumerator().multiply(this.denominator)),
				this.denominator.multiply(fraction.denominator));
	}
	...
	public BigFraction multiply(BigFraction fraction) {
		return new BigFraction(this.numerator.multiply(fraction.getNumerator()),
	...
	public BigFraction divide(BigFraction fraction) {
		return new BigFraction(this.numerator.multiply(fraction.getDenominator()),
	...
	public String toString() {
		if (this.denominator.intValue() == 1)
	...
	public int compareTo(BigFraction fraction) {
		int firstNumerator = this.numerator.multiply(fraction.getDenominator()).intValue();
		int secondNumerator = fraction.getNumerator().multiply(this.denominator).intValue();
