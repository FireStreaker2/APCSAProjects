...
public class BigTest {
  ...
  public static void main(String[] args) {
    ...
    if (passed < total) System.err.println(
  ...
  private static void test(
    ...
    try {
      ...
      BigFraction operand1 = new BigFraction(tokens[0]);
      BigFraction operand2 = new BigFraction(tokens[2]);
      String operator = tokens[1];

      BigFraction saved1 = new BigFraction(
        operand1.getNumerator(),
        operand1.getDenominator()
      );
      BigFraction saved2 = new BigFraction(
        operand2.getNumerator(),
        operand2.getDenominator()
      );
      ...
      if (
        operand1.getNumerator().compareTo(saved1.getNumerator()) != 0 ||
        operand1.getDenominator().compareTo(saved1.getDenominator()) != 0
      ) {
        System.err.println(
          "Fail      : input = \"" +
          input +
          "\", first operand was modified, before = \"" +
          saved1 +
          "\", after = \"" +
          operand1 +
          "\""
        ...
        operand2.getNumerator().compareTo(saved2.getNumerator()) != 0 ||
        operand2.getDenominator().compareTo(saved2.getDenominator()) != 0
      ) {
        System.err.println(
          "Fail      : input = \"" +
          input +
          "\", second operand was modified, before = \"" +
          saved2 +
          "\", after = \"" +
          operand2 +
          "\""
      ...
      // Check for the same sign on compareTo tests
        ...
        result == null &&
        Integer.signum(intResult) != Integer.signum(Integer.parseInt(expected))
      ) {
        System.err.println(
          "Fail      : input = \"" +
          input +
      ...
      // Check for same result on operator tests
        ...
        result.getNumerator().equals(BigInteger.valueOf(numerator)) &&
        result.getDenominator().equals(BigInteger.valueOf(denominator)) &&
        expected.equals(result.toString()) &&
        expectedMixed.equals(result.toMixedNumberString())
      ) {
        passed += 1;
        System.out.println(
          "Success   : input = \"" +
      ...
      System.err.println(
        "Exception : input = \"" + input + "\", expected \"" + expected + "\""
      );
