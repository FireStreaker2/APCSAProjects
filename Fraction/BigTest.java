   ...
   //   _____   ____    _   _  ____ _______   ______ _____ _____ _______ 
	...
	{	
        ...
        try 
        {
        	...
        	BigFraction saved1   = new BigFraction(operand1.getNumerator(), operand1.getDenominator());
        	BigFraction saved2   = new BigFraction(operand2.getNumerator(), operand2.getDenominator());
        	...
        	if (operand1.getNumerator().compareTo(saved1.getNumerator()) != 0 || operand1.getDenominator().compareTo(saved1.getDenominator()) != 0)
        	{
            	System.err.println("Fail      : input = \"" + input + "\", first operand was modified, before = \"" + saved1 + "\", after = \"" + operand1 + "\"");
        	}
        	else if (operand2.getNumerator().compareTo(saved2.getNumerator()) != 0 || operand2.getDenominator().compareTo(saved2.getDenominator()) != 0)
        	{
        	...
        	else if (result.getNumerator().equals(BigInteger.valueOf(numerator)) && result.getDenominator().equals(BigInteger.valueOf(denominator)) && expected.equals(result.toString()) && expectedMixed.equals(result.toMixedNumberString())) 
        	{
            	passed += 1;
