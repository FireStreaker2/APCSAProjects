public class Test {
  ...
  private static void test(
    ...
    try {
      ...
      Fraction saved1 = new Fraction(
        operand1.getNumerator(),
        operand1.getDenominator()
      );
      Fraction saved2 = new Fraction(
      ...
      if (
        operand1.getNumerator() != saved1.getNumerator() ||
        operand1.getDenominator() != saved1.getDenominator()
      ) {
        System.err.println(
          "Fail      : input = \"" +
          input +
        ...
        operand2.getNumerator() != saved2.getNumerator() ||
        operand2.getDenominator() != saved2.getDenominator()
      ) {
        System.err.println(
          "Fail      : input = \"" +
          input +
      ...
      // Check for same result on operator tests
        ...
        result.getNumerator() == numerator &&
        result.getDenominator() == denominator &&
