...
public class Program extends JPanel {
  ...
  public void paint(Graphics g) {
    ...
    g.drawString(
      "Step into the exciting world of our Number Guessing Game,",
      60,
      220
    );
    g.drawString(
      "a fun and challenging activity designed to test your intuition",
      60,
      240
    );
    g.drawString(
      "and logic. Perfect for all ages, this game will keep you",
      60,
      260
    );
    g.drawString(
      "entertained as you try to guess the secret number within",
      60,
      280
    );
    ...
    g.drawString(
      "Wordle is a very simple game. Players have six attempts to",
      560,
      220
    );
    g.drawString(
      "guess a five-letter word, with feedback given for each guess",
      560,
      240
    );
    g.drawString(
      "in the form of colored tiles indicating when letters match or",
      560,
      260
    );
    ...
    for (Integer[] point : clicks) {
      if (
        point[0] >= 50 && point[0] <= 500 && point[1] >= 150 && point[1] <= 650
      ) {
