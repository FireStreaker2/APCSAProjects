...
public class Greetings {
	...
	public static void main(String[] args) {
		...
		String restOfLastName = lastName.toLowerCase().substring(1, lastName.length());

		// find current age
		int age = currentYear - birth;

		// print result
		System.out.println("Greetings, " + firstInitial + ". " + lastInitial + restOfLastName + "! You are about " + age + " years old.");
	}
